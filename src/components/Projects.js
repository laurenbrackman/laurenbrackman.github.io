              ...
              <div className={isVisible ? "animate__animated animate__fadeIn": ""}>
                ...
                <Tab.Container id="projects-tabs" defaultActiveKey="first">
                  <Nav variant="pills" className="nav-pills mb-5 justify-content-center align-items-center" id="pills-tab">
                    ...
                    <Nav.Item>
                      <Nav.Link eventKey="second">North Bridger Bison</Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                  ...
                  <Tab.Content id="slideInUp" className="content">
                    ...
                    <h3>The Client</h3>
                      ...
                      <h3>What I Learned</h3>
                      <p><li>Prioritizing user research was crucial in crafting a design that resonated with the target audience. I found that the ideal client was much more diverse than I initially would have design for.</li>
                      <li>Emphasizing clear FAQs and visual aids helped cultivate trust with customers, mitigating friction points in the customer journey and bolstering confidence in the purchasing in such a large quantity.</li></p>
                    </Tab.Pane>
