                  ...
                  <Container>
                    ...
                    <Row>
                      ...
                      <div className="casestudy">
                        ...
                        <h3>What I Learned</h3>
                        <h5>User Research</h5><li>Prioritizing user research was crucial in crafting a design that resonated with the target audience. I found that the ideal client was much more diverse than I initially would have design for.</li>
                        <h5>Addressing Pain Points</h5><li>Emphasizing clear FAQs and visual aids helped cultivate trust with customers, mitigating friction points in the customer journey and bolstering confidence in the purchasing in such a large quantity.</li>
                      </div>
                    </Tab.Pane>
                    ...
                    <div className="casestudy">
                      ...
                      <Container className="projectphotos">
                        <Row>
